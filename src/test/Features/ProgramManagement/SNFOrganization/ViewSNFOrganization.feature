Feature: View SNF organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    And I verify <StateVerification> in "state" on view profile of "SNF" Organization
    And I verify <Postal_Code> in "zip" on view profile of "SNF" Organization
    And I verify CCN id "<CCN> - <Has_MO>" on "SNF" organization profile page
    And I verify EIN/TIN id "<EIN/TIN> - <Has_MO>" on "SNF" organization profile page
  ...
  Scenario Outline: <Description>
    ...
    And I search with "<SNF_Name1>" on organization in search box
    Then I verify the "No matches" message for invalid search in Organization
    And I verify the "Create New SNF Organization" link under No matches
    And I click on "Create New SNF Organization" link under No matches
    And I verify "Create SNF Organization" header text on create organization page
    And I verify "Has a Management Organization" radio button is checked
    And I verify Managing Organization is auto filled on "create SNF" Organization page
    Then I enter <SNF_Name> in "SNF Organization Name" on create organization page
    ...
    Examples: 
      | Description                                                             | MO_Name | SNF_Name1        | SNF_Name | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Loc_Type        | Loc_Address2 | Loc_Region | Loc_City | Loc_Market | Loc_State  | Loc_Postal_Code | CCN | EIN | NPI | StateVerification | Message                                |
      | Searching invalid details on Managing Organization Profile Page for SNF | MONAME  | NoMatchesSNFNAME | SNFNAME  | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Skilled Nursing | Loc_Address2 | Midwest    | Loc_City | Chicago    | California |           10000 | CCN | EIN | NPI | CA                | SNF Organization Successfully Created. |
