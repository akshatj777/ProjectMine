Feature: Create LTCH organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check validation for blank Managing Organization | YES    | Blank        | LTCHNAME  | Address1 | City | California |       10000 | LocName  | LAddress1    | LCity    | California |           10001 | CCN | EIN | NPI | Please select one option |
