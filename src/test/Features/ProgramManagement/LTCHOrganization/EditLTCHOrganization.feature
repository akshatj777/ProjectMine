Feature: Edit LTCH organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit LTCH organization with MO to without MO        | YES    | NO      | MO2          | LTCHNAME  | LTCHNAME         | Address1     | Short_Name | Address2     | City | California |           10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | LTCH Organization Successfully Updated. |
      | Edit verify LTCH organization without MO to with MO | NO     | YES     | MO2          | LTCHNAME  | LTCHNAME         | Address1     | Short_Name | Address2     | City | California |           10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 | LTCH Organization Successfully Updated. |
  ...
  Scenario Outline: <Description>
    ...
    When I click on Organization link on Program Management page
    When I click on "LTCH" organization tab on organization dashboard
    Then I search with "<LTCH_Name> - <Has_MO1>" on organization in search box
    And I verify "<LTCH_Name> - <Has_MO1>" field in search list on organization page
    And I click "<LTCH_Name> - <Has_MO1>" field in search list on organization page
    And I click on "Edit" button on particular organization
    And I verify Managing Organization radio buttons status on "Edit LTCH - <Has_MO>" organization page
    And I select "<Has_MO>" radio button for managing organization
    Then I select "<Managing_Org>" managing organization name in "<Has_MO>" Has a Management Organization drop down
    ...
    And I click "<LTCH_Name> - <Has_MO>" field in search list on organization page
    And I verify "<LTCH_Name> - <Has_MO>" name on the header of view profile
    And I verify "Managing Organization2 - <Has_MO>" on view profile of "LTCH" Organization

    Examples: 
      | Description                               | Has_MO | Has_MO1 | Managing_Org | LTCH_Name | Edited_LTCH_Name | Org_Address1 | Short_Name | Org_Address2 | City | State      | Org_Postal_Code | Loc_Name | Loc_Address1 | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | Message                                 |
      | Changing the MO details on edit LTCH page | YES    | NO      | MO_Name2     | LTCHNAME  | LTCHNAME         | Address1     | Short_Name | Address2     | City | California |           10000 | Loc_Name | Loc_Address1 | Loc_Address2 | Loc_City | California |           10000 | LTCH Organization Successfully Updated. |
