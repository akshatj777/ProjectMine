Feature: Create Hospice organization functionality tests
  ...
  Scenario: Verification of availability of all the fields on Create Hospice Organization page
    ...
    And I verify "Database ID" header label under "Hospice" organization
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check validation for blank Managing Organization | YES    | Blank        | HOSPICENAME  | Address1 | City | California |       10000 | CCN | EIN | NPI | Please select one option |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for CCN field - Less than 6 characters |                                                                              |                                                           |                                                |                                                           |                                                |              | lessThan4   |             |              | The CCN must be at least 4 characters.                         |
