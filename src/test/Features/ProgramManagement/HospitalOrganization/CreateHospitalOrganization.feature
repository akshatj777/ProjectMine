Feature: Create Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check validation for blank Managing Organization | YES    | Blank        | ACHNAME   | Address1 | City | California |       10000 | LocName  | LAddress1    | LCity    | California |           10001 | CCN | EIN | NPI | Please select one option                |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                              | Has_MO | Managing_Org | Hosp_Name | Address1 | Short_Name | Address2 | City | State      | Postal_Code | Loc_Name | Loc_Address1 | Loc_Type  | Loc_Region | Loc_Market | Loc_Address2 | Loc_City | Loc_State  | Loc_Postal_Code | Location_ID | CCN | EIN | NPI | Message                                     |
      | Create and verify Hospital Organization with Same multiple location details - Without MO | NO     |              | ACHNAME   | Address1 | Short_Name | Address2 | City | California |       10000 | Loc_Name | Loc_Address1 | Inpatient | Midwest    | Chicago    | Loc_Address2 | Loc_City | California |           10000 |  1234567890 | CCN | EIN | NPI | Hospital Organization Successfully Created. |
  ...
  Scenario Outline: <Description>
    ...
    Then I click on "Submit" button on "create" organization page
    Then I verify "<Message>" after submitting the "create ACH - <Has_MO>" organization page
    When I search with "<Hosp_Name> - <Has_MO>" on "SNF" organization in search box
    And I click "<Hosp_Name> - <Has_MO>" field in search list on "SNF" organization page
    And I verify Location ID should be greater than "100000"
    When I click on Organization link on Program Management page
    When I click on "Hospital" organization tab on organization dashboard
    Then I click on "+" button on "Hospital" organization page
