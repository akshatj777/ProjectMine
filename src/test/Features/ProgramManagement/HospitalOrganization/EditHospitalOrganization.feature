Feature: Edit Hospital organization functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Check Character Limit for Location Id field on Edit Hospital Organization page             | NO     | ACHNAME   |                                                                              |                                                           |                                                |                                                           |                                                |                 |                                                                                |                                                           |                                                           |                                                | 10000-00000     | LIDgreaterThan20 | The Location Id may not be greater than 20 characters.         |
