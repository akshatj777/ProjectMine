Feature: Edit Bundle Payment Contract functionality tests
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Validation message for editing Contract with Contract End Date is before the Contract Start Date         | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | 2019/02/09        | 2017/01/07      | 2019/05/01      | 2020/10/30    | 2019/07/02     | 2020/02/01   | 2019/08/09        | 2019/11/12      | The Contract End Date is before the start date              |
      | Validation message for editing Contract with Bundle End Date is before the bundle Start Date             | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | 2019/02/09        | 2021/12/19      | 2019/05/01      | 2018/04/23    | 2019/07/02     | 2020/02/01   | 2019/08/09        | 2019/11/12      | The bundle end date is before the bundle start date         |
      | Validation message for editing Contract with Bundle Price End Date is before the Bundle Price Start Date | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | 2019/02/09        | 2021/12/19      | 2019/01/01      | 2020/06/30    | 2019/07/01     | 2019/02/01   | 2019/08/09        | 2019/11/12      | The bundle end date is before the bundle start date         |
      | Validation messages for editing Contract with Bundle End Date is after Contract End Date                 | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | 2019/02/09        | 2021/12/19      | 2019/05/01      | 2021/12/21    | 2019/07/02     | 2020/02/01   | 2019/08/09        | 2019/11/12      | The bundle end date is after the contract end date          |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit contract using duplicate Bundles with overlapping dates | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | FETCHFROMAPI |     98 | 2019/03/01       | 2020/04/30     | 2019/05/03      | 2019/12/26    | 2019/03/09         | 2019/05/12       |            37 |           57 |           77 | Bundle Date Range overlaps with other bundle |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Validation message if newly added Bundle Bundle Price End Date is before the Bundle Price Start Date | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | FETCHFROMAPI |     98 | 2020/07/30       | 2020/12/25     | 2020/07/01      | 2020/06/01    | 2020/09/01         | 2020/09/30       |            37 |           57 |           77 | The bundle end date is before the bundle start date         |
      | Validation message if newly added Bundle Bundle End Date is after Contract End Date                  | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | FETCHFROMAPI |     98 | 2020/07/30       | 2022/12/31     | 2020/07/01      | 2020/11/01    | 2020/09/01         | 2020/09/30       |            37 |           57 |           77 | The bundle end date is after the contract end date          |
      | Validation message if newly added Bundle Bundle Price End Date is after Bundle End Date              | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | FETCHFROMAPI |     98 | 2020/07/30       | 2020/12/28     | 2020/07/01      | 2020/12/31    | 2020/09/01         | 2020/09/30       |            37 |           57 |           77 | The bundle price end date is after the bundle end date      |
      | Validation message if newly added Bundle Bundle Start Date is before the Contract Start Date         | PAYORNAME  | PROGRAMNAME             | PROGRAMNAME | FETCHFROMAPI |     98 | 2017/01/01       | 2020/12/28     | 2020/07/01      | 2020/11/30    | 2020/09/01         | 2020/09/30       |            37 |           57 |           77 | The bundle start date is before the contract start date     |
