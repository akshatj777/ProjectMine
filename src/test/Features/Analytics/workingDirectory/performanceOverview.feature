Feature: Performance Overview Dashboard Validations
  ...
  Scenario Outline: Front end Data Filter Validation for Claims
    ...
    Examples: 
      ...
      | Qafivedashtest@yopmail.com  |   1 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True Random | Skip            | Skip        | Skip                   |
      | Qatwodashtest@yopmail.com   |   2 | True Random | True Random | True Random | Skip                   | Skip            | Skip        | True Random | Skip            | Skip        | Skip                   |
      | Qadashboardtest@yopmail.com |   3 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True All    | Skip            | Skip        | Skip                   |
      | Qafivedashtest@yopmail.com  |   4 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True Random | Skip            | Skip        | Skip                   |
      ...
      | Qafivedashtest@yopmail.com  |   7 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True Random | True Random     | Skip        | Skip                   |
      | allmodel123@yopmail.com     |   8 | True All    | True All    | Skip        | Skip                   | Skip            | True Random | True All    | True Random     | True All    | Skip                   |
      | allmodel123@yopmail.com     |   9 | True Random | True Random | True Random | Skip                   | Skip            | True Random | True Random | True Random     | True Random | Skip                   |
  ...
  Scenario Outline: Front end Data Filter Validation for EC
    ...
    Examples: 
      ...
      | Qafivedashtest@yopmail.com  |   1 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True Random | Skip            | Skip        | Skip                   |
      | Qatwodashtest@yopmail.com   |   2 | True Random | True Random | True Random | Skip                   | Skip            | Skip        | True Random | Skip            | Skip        | Skip                   |
      | Qadashboardtest@yopmail.com |   3 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True Random | Skip            | Skip        | Skip                   |
      | Qafivedashtest@yopmail.com  |   4 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True All    | Skip            | Skip        | Skip                   |
      | Qatwodashtest@yopmail.com   |   5 | True Random | True Random | Skip        | Skip                   | Skip            | True Random | True All    | Skip            | Skip        | Skip                   |
      | Qadashboardtest@yopmail.com |   6 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | True All    | Skip            | Skip        | Skip                   |
      ...
      | Qafivedashtest@yopmail.com  |  10 | True All    | True All    | Skip        | Skip                   | Skip            | Skip        | Skip        | Skip            | Skip        | Skip                   |
      | Qatwodashtest@yopmail.com   |  11 | True Random | True Random | True Random | Skip                   | Skip            | True Random | True Random | True Random     | Skip        | Skip                   |
  ...
  Scenario Outline: Front end Data Filter Validation for Claims&EC
    ...
    Examples: 
      ...
      | Qafivedashtest@yopmail.com  |   7 | True Random | True Random | Skip        | Skip                   | Skip            | Skip        | Skip        | True Random     | Skip        | Skip                   |
      | allmodel123@yopmail.com     |   8 | True All    | True All    | Skip        | Skip                   | Skip            | True Random | Skip        | True Random     | True All    | Skip                   |
      | allmodel123@yopmail.com     |   9 | True Random | True Random | True Random | Skip                   | Skip            | True Random | True All    | True Random     | True Random | Skip                   |
      | Qafivedashtest@yopmail.com  |  10 | True All    | True All    | Skip        | Skip                   | Skip            | Skip        | True Random | Skip            | Skip        | Skip                   |
      | Qatwodashtest@yopmail.com   |  11 | True Random | True Random | True Random | Skip                   | Skip            | True Random | Skip        | True Random     | Skip        | Skip                   |
  ...
  Scenario Outline: Execute Filter combinations to Validate Data Metrics on Front End - For Claims
    ...
    And I Save "% SNF Disch Current" data metric FE value on the dashboard for "Claims" with picture resolution "1000X1000"
