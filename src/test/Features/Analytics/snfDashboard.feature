Feature: Verify SNF Scorecard Dashboard

  Scenario: Verify the functional test cases under SNF Scorecard dashbaord
    ...
    And I click on "SNF Scorecard" dashboard
    And I switch to analytics iframe
    #Then I verify "SNF Comparison" text is appearing inside dashboard
    ...
    And I verify "SNF Spend" is appearing for BAN section on the dashboard
    ...
    Then I verify graph for "SNF Comparison by Volume" is appearing on the "SNF Scorecard" dashboard

  Scenario: Verify the mouse hovering text on the SNF Scorecard dashbaord page
    Given I am on the login page
    When I enter incorrect "email" for analytics as "Qafivedashtest@yopmail" for login
    And I enter password field Testing123 for Login
    Then I click Access button
  ...
  Scenario: Validate the filter fields on SNF Scorecard dashbaord 
    Given I am on the login page
    When I enter email field Qafivedashtest@yopmail.com for login
    And I enter password field Testing123 for Login
    Then I click Access button
    ...
    And I switch to analytics iframe
    #Then I verify "SNF Comparison" text is appearing inside dashboard
    And I verify "Post Acute Facility - CCN" is appearing on the "SNF Scorecard" dashboard
    And I verify "Bundle" is appearing on the "SNF Scorecard" dashboard
    And I verify "Remedy Region Market" is appearing on the "SNF Scorecard" dashboard
    And I verify "Partner Region Market" is appearing on the "SNF Scorecard" dashboard
    And I verify "Participant" is appearing on the "SNF Scorecard" dashboard
    And I verify "Episode Initiator - BPID" is appearing on the "SNF Scorecard" dashboard
    And I verify "Anchor Facility - CCN" is appearing on the "SNF Scorecard" dashboard
    And I verify "Time" is appearing on the "SNF Scorecard" dashboard
  ...
  Scenario: Verify data filter validations on SNF Scorecard dashbaord
    ...
    And I click "Episode Initiator - BPID" Filter on the "SNF Scorecard" dashboard
    And I verify Episode Initiator BPID values with database value
    And I click "Episode Initiator - BPID" Filter on the "SNF Scorecard" dashboard
    Then I select "Penn Presbyterian Medical Center - 2070-021" from "Episode Initiator - BPID" field and click on "Apply"
    And I click "Anchor Facility - CCN" Filter on the "SNF Scorecard" dashboard
    And I verify Facility name and ccn values with database values
    And I click "Anchor Facility - CCN" Filter on the "SNF Scorecard" dashboard
    And I click "Participant" Filter on the "SNF Scorecard" dashboard
    And I verify Participant Data Filter values with database values for selected Episode Initiator BPID
    And I click "Participant" Filter on the "SNF Scorecard" dashboard
    And I click "Remedy Region - Market" Filter on the "SNF Scorecard" dashboard
    And I verify Remedy Region Market at row level security with database values for selected Episode Initiator BPID
    And I click "Remedy Region - Market" Filter on the "SNF Scorecard" dashboard
    And I click "Partner Region - Market" Filter on the "SNF Scorecard" dashboard
    And I verify Partner Region Market at row level security with database values for selected Episode Initiator BPID
    And I click "Partner Region - Market" Filter on the "SNF Scorecard" dashboard
    And I click "Post Acute Facility - CCN" Filter on the "SNF Scorecard" dashboard
    #And I verify Facility name and ccn values with database values
    And I click "Post Acute Facility - CCN" Filter on the "SNF Scorecard" dashboard
    And I click "Bundle" Filter on the "SNF Scorecard" dashboard
