Feature: Approach for Program Performance Dashboard
  ...
  Scenario: Execute JMX file and read Output data for Data Metrics Validation
    ...
    When I execute the jmeter application and execute jmx file "\\src\\test\\Jmeter\\PerformanceDashboard\\TableauTestClaims.jmx"
    Then I read the values from the text file "\\src\\test\\Jmeter\\PerformanceDashboard\\PerformanceDashboardResult.txt"

  Scenario Outline: Claims Data Metric validation for Filters - BPID, CCN
  ...
  Scenario: Execute JMX file and read Output data for Data Metrics Validation
    Given I clear output data for Data metrics from "\\src\\test\\Jmeter\\PerformanceDashboard\\PerformanceDashboardResult.txt" Output file
    When I execute the jmeter application and execute jmx file "\\src\\test\\Jmeter\\PerformanceDashboard\\TableauTestEC.jmx"
    Then I read the values from the text file "\\src\\test\\Jmeter\\PerformanceDashboard\\PerformanceDashboardResult.txt"

  Scenario Outline: EC Data Metric validation for Filters - BPID, CCN
    Given I get the value "<Output_Row>" from Output file of data metric validation
    Given I am on the login page
    When I enter email field Qafivedashtest@yopmail.com for login
    And I enter password field Testing123 for Login
   ...
   Scenario: Execute JMX file and read Output data for Data Metrics Validation
    Given I clear output data for Data metrics from "\\src\\test\\Jmeter\\PerformanceDashboard\\PerformanceDashboardResult.txt" Output file
    When I execute the jmeter application and execute jmx file "\\src\\test\\Jmeter\\PerformanceDashboard\\TableauTestClaims&EC.jmx"
    Then I read the values from the text file "\\src\\test\\Jmeter\\PerformanceDashboard\\PerformanceDashboardResult.txt" 
      
   Scenario Outline: EC & Claims Data Metric validation for Filters - BPID, CCN
    Given I get the value "<Output_Row>" from Output file of data metric validation
    Given I am on the login page
    When I enter email field Qafivedashtest@yopmail.com for login
    And I enter password field Testing123 for Login
