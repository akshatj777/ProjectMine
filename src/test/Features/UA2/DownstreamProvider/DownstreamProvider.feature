Feature: Create Downstream Provider user from Super Admin and Validate the user profile page
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | View Downstream Provider user created from Super Admin user | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName | 998-877-6655 | Downstream Provider | Episode Connect Classic | Administration, Care Innovation Institute, Reporting Classic, Lessons |     |                 | Healthsystem - Downstream Provider | Healthsystem - Downstream Provider--Downstream Organization | Healthsystem - Downstream Provider--DOWN-ORG--Abbeville General Hospital, Healthsystem - Downstream Provider--DOWN-ORG--Litchford Falls Nursing & Rehabilitation Center, Healthsystem - Downstream Provider--DOWN-ORG--Coosa valley health care, Healthsystem - Downstream Provider--DOWN-ORG--Alaris Health at Jersey City |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with DownStream Provider and verify Product Tiles and their redirections | Super Admin | FirstNameFirstNameFirstNameFirstNameFirst | LastName | Downstream Provider | Episode Connect Classic, Care Innovation Institute | Episode Connect for Post-acute Care, Administration, Lessons, Reporting Classic | ROLE_SNF | Patient ID     | Episode DRG Issues |      | i am learning path, Learning Pathway 2, max-test-052417, New learning Path, Remedy University | Abbeville General Hospital, Litchford Falls Nursing & Rehabilitation Center, Coosa valley health care, Alaris Health at Jersey City |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                 | User        | UserName                               | Password | FirstName                                 | LastName | Phone        | Role                | ApplicationsEnabled                 | ApplicationsNotVisible                                                | NPI | LearningPathway | HealthSystem                       | Programs                                                    | Locations                                                                                                                                                                                                                                                                                                                                                                        |
      | View Downstream Provider user created from Super Admin user | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName | 998-877-6655 | Downstream Provider | Episode Connect for Post-acute Care | Administration, Care Innovation Institute, Reporting Classic, Lessons |     |                 | Healthsystem - Downstream Provider | Healthsystem - Downstream Provider--Downstream Organization |  Healthsystem - Downstream Provider--DOWN-ORG--Abbeville General Hospital, Healthsystem - Downstream Provider--DOWN-ORG--Litchford Falls Nursing & Rehabilitation Center, Healthsystem - Downstream Provider--DOWN-ORG--Coosa valley health care, Healthsystem - Downstream Provider--DOWN-ORG--Alaris Health at Jersey City |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                    | User        | FirstName                                 | LastName | Role                | Applications                                                   | ApplicationsNotVisible                                              | Roletext | ReportCategory | ReportName         | BPID | LearningPathway                                                                               | Facilities                                                                                                                                                                       |
      | Login with DownStream Provider and verify Product Tiles and their redirections | Super Admin | FirstNameFirstNameFirstNameFirstNameFirst | LastName | Downstream Provider | Episode Connect for Post-acute Care, Care Innovation Institute | Episode Connect Classic, Administration, Lessons, Reporting Classic | ROLE_SNF | Patient ID     | Episode DRG Issues |      | i am learning path, Learning Pathway 2, max-test-052417, New learning Path, Remedy University |Abbeville General Hospital, Litchford Falls Nursing & Rehabilitation Center, Coosa valley health care, Alaris Health at Jersey City |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                 | User        | UserName                               | Password | FirstName                                 | LastName | Phone        | Role                | ApplicationsEnabled                                          | ApplicationsNotVisible                                                | NPI | LearningPathway | HealthSystem                       | Programs                                                    | Locations                                                                                                                                                                                                                                                                                                                                                                        |
      | View Downstream Provider user created from Super Admin user | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName | 998-877-6655 | Downstream Provider | Episode Connect Classic, Episode Connect for Post-acute Care | Administration, Care Innovation Institute, Reporting Classic, Lessons |     |                 | Healthsystem - Downstream Provider | Healthsystem - Downstream Provider--Downstream Organization |  345454, Coosa valley health care, Alaris Health at Jersey City, Abbeville General Hospital Healthsystem - Downstream Provider--DOWN-ORG--Abbeville General Hospital, Healthsystem - Downstream Provider--DOWN-ORG--Litchford Falls Nursing & Rehabilitation Center, Healthsystem - Downstream Provider--DOWN-ORG--Coosa valley health care, Healthsystem - Downstream Provider--DOWN-ORG--Alaris Health at Jersey City |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                    | User        | FirstName                                 | LastName | Role                | Applications                                                                            | ApplicationsNotVisible                     | Roletext | ReportCategory | ReportName         | BPID | LearningPathway                                                                               | Facilities                                                                                                                                                                       |
      | Login with DownStream Provider and verify Product Tiles and their redirections | Super Admin | FirstNameFirstNameFirstNameFirstNameFirst | LastName | Downstream Provider | Episode Connect Classic, Episode Connect for Post-acute Care, Care Innovation Institute | Administration, Lessons, Reporting Classic | ROLE_SNF | Patient ID     | Episode DRG Issues |      | i am learning path, Learning Pathway 2, max-test-052417, New learning Path, Remedy University | Abbeville General Hospital, Litchford Falls Nursing & Rehabilitation Center, Coosa valley health care, Alaris Health at Jersey City|
  ...
  Scenario Outline: Validating that Error is getting displayed on searching any downstream provider location less than 5 alphabets and clicking on pagination on creating and editing Downstream Provider role
    ...
    Examples: 
      ...
      | Login with Super Admin User and create user with Downstream Provider role | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName | qaautomation@remedypartners.com | Downstream Provider | Episode Connect Classic | Administration, Care Innovation Institute, Reporting Classic, Lessons |     |                                | Bap | Alaris Health at Jersey City |
  ...
  Scenario Outline: Validating Cross(X) icon for Downstream Provider role
    ...
    Examples: 
      ...
      | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName | qaautomation@remedypartners.com | 9988776655 | Downstream Provider | Episode Connect Classic |     | Coosa Valley Health Care |
