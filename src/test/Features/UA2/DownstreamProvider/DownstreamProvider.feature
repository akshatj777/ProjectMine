Feature: Create Downstream Provider user from Super Admin and Validate the user profile page
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Super Admin User and create user with Downstream Provider role | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName | qaautomation@remedypartners.com | 9988776655 | Downstream Provider | Remedy University | Administration, Reporting Classic, Reporting, Care Connect, Care Innovation Institute |     | HZhmTBQzHtU1, NFdw0Kts2C01, max-test-052417 | 345454, Coosa valley health care, Alaris Health at Jersey City, Abbeville General Hospital |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with DownStream Provider and verify Product Tiles and their redirections | Super Admin | FirstNameFirstNameFirstNameFirstNameFirst | LastName | Downstream Provider | Remedy University, Care Innovation Institute | Administration, Reporting Classic, Reporting, Care Connect, Episode Connect Classic, Episode Connect for Post-acute Care, Community Connect | ROLE_SNF | Patient ID     | Episode DRG Issues |      | New learning Path, Learning Pathway 2, max-test-052417 | Abbeville General Hospital, Litchford Falls Nursing & Rehabilitation Center, Coosa valley health care, Alaris Health at Jersey City |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                    | User        | FirstName                                 | LastName | Role                | Applications                                       | ApplicationsNotVisible                                                                                                                | Roletext | ReportCategory | ReportName         | BPID | LearningPathway                                                                               | Facilities                                                                                                                          |
      | Login with DownStream Provider and verify Product Tiles and their redirections | Super Admin | FirstNameFirstNameFirstNameFirstNameFirst | LastName | Downstream Provider | Episode Connect Classic, Care Innovation Institute | Administration, Reporting Classic, Reporting, Care Connect, Episode Connect for Post-acute Care, Remedy University, Community Connect | ROLE_SNF | Patient ID     | Episode DRG Issues |      | i am learning path, Learning Pathway 2, max-test-052417, New learning Path, Remedy University | Abbeville General Hospital, Litchford Falls Nursing & Rehabilitation Center, Coosa valley health care, Alaris Health at Jersey City |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                 | User        | UserName                               | Password | FirstName                                 | LastName | Phone        | Role                | ApplicationsEnabled                                    | ApplicationsDisabled                       | ApplicationsNotVisible                                       | NPI | LearningPathway | HealthSystem                       | Programs                                                    | Locations                                                                                                                                                                                                                                                                                                                   |
      | View Downstream Provider user created from Super Admin user | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName | 998-877-6655 | Downstream Provider | Episode Connect for Post-acute Care, Community Connect | Episode Connect Classic, Remedy University | Administration, Care Innovation Institute, Reporting Classic |     |                 | Healthsystem - Downstream Provider | Healthsystem - Downstream Provider--Downstream Organization | Healthsystem - Downstream Provider--DOWN-ORG--Abbeville General Hospital, Healthsystem - Downstream Provider--DOWN-ORG--Litchford Falls Nursing & Rehabilitation Center, Healthsystem - Downstream Provider--DOWN-ORG--Coosa valley health care, Healthsystem - Downstream Provider--DOWN-ORG--Alaris Health at Jersey City |
