Feature: Edit page for Downstream provider
  ...
  Scenario Outline: Remove exiting health System and new org
    ...
    Examples: 
      ...
      | Super Admin | qaautomation@remedypartners.com | Downstream Provider | FirstNameEdited | LastNameEdited | 996-385-2451 | Episodes          | Episodes, Episodes 2.0 | Administration, Physician Connect, Reports, Lessons | Covenant            | Yes              | Apple Rehab    | 3056-i11--Apple - Watertown | Healthsystem - Downstream Provider, Apple Rehab | Apple Rehab--BPCI Model 3, Healthsystem - Downstream Provider--Downstream Organization | Apple Rehab--3056-i11--Apple - Watertown, Healthsystem - Downstream Provider--DOWN-ORG--Coosa Valley Health Care, Healthsystem - Downstream Provider--DOWN-ORG--020653 | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] | i am learning path, Learning Pathway 2, Remedy University |      | Apple - Watertown, Coosa valley health care, Alaris Health at Jersey City |
