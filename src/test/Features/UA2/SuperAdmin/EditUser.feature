Feature: Edit user page for SA
  ...
  Scenario Outline: Create User through UA API call
    ...
    Examples: 
      ...
      | Super Admin | FirstName                                 | LastNameLastNameLastNameLastNameLastName | qaautomation@remedypartners.com |            |     | Prospective Partner Executive   | 15-Prospective Partner Executive   | lessons-Remedy University                                                                                                                                                                                                                                                | HZhmTBQzHtU1                                                                                                         | 441324--6005-059--140007, 441324--6005-059--140010                                                                                                                                                                                                                                                                                                                         |           200 |
