Feature: Edit user page for SA
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Verify validation message for NPI as alphabets        | Super Admin | First Name | Last Name  | qaautomation@remedysystems.com2 | 9874563210 | Physicians | .          | Please enter a valid NPI          |
