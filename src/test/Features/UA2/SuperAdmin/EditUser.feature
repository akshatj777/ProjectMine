Feature: Edit user page for SA
  ...
  Scenario Outline: Verify the functionality of back/Cancel button
    ...
    Examples: 
      | User        | Role   | HasHealthSystem2 | Health System    | Role    |
      | Super Admin | Leader | Yes              | Sound Physicians | Manager |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Change user role and then provision the user                                | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | qaautomation@remedysystems.com |     |              | Leader                          | Partner Program Administrator   | Episode Connect for Post-acute Care                                  | Episode Connect Classic, Reporting Classic, Remedy University            | Episode Connect Classic, Reporting Classic, Remedy University, Episode Connect for Post-acute Care                                             |                                                                                  | Episodes Classic, Reporting Classic, Remedy University, Episodes Post Acute, Care Innovation Institute                                                                    | Community Connect, Care Connect, Reporting, Administration                                              |                                      |                   |                                   |                                                          | ROLE_PRM | Patient ID     | Episode DRG Issues           |      | i am learning path, Learning Pathway 2, Remedy University                                                                                                | FirstNameFirstNameFirstNameFirstNameFirst | LastNameLastNameLastNameLastNameLastName | Stamford Hospital                                                                                                 |                                                               |                 |                |                                                                        |                  |                            |                                                                                                              |                                                               |                                                                                                         |                                                                                                                                                                                                                                           |                  |                  |              |                                                                             |                  |                                                                        |              |                                                |                                                                                                                          |                 |                    |                                     |                 |                                                                        |  |
