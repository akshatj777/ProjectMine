Feature: Edit user page for SA
  ...
  Scenario Outline: Remove selected locations and then remove the org
    ...
    Examples: 
      ...
      | Super Admin | Remedy Program Administrator | St. Lukes Health Network, Inc. DBA St. Lukes University Health Network | 2070-025--ST LUKE'S HOSPITAL - ANDERSON CAMPUS |
