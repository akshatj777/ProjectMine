Feature: Edit user page for SA
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Change application access and learning pathway and then provision the user                             | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | qaautomation@remedysystems.com |     |              |                                 | Remedy Sales PAC Demo 2018      |                                                                                          |                                                                                                                      | Episode Connect, Episode Connect Classic, Care Innovation Institute, Episode Connect for Post-acute Care                                                                                                       | Episode Connect for Post-acute Care                                              | Episode Connect, Episode Connect Classic, Care Innovation Institute                                                                                                                                            | Episode Connect, Episode Connect Classic, Care Innovation Institute                                                                                                                                            | Community Connect, Care Connect, Administration, Program Management, Reporting, Reporting Classic, Remedy University, Episode Connect for Post-acute Care |                                       |                   |                                                          |                                | ROLE_SNF       | Patient ID     | Episode DRG Issues |      |                                                                                                                                                          | FirstNameFirstNameFirstNameFirstNameFirst | LastNameLastNameLastNameLastNameLastName | Anderson                                                                                 |                                                               | 2070-023--Bethlehem |                | St. Lukes Health Network, Inc. DBA St. Lukes University Health Network |                  |                            |                                                                                                              | St. Lukes Health Network, Inc. DBA St. Lukes University Health Network | St. Lukes Health Network--BPCI Model 2                                                                  | St. Lukes Health Network--2070-025--Anderson                                                                                                                                                                                              |                  |                  |              |                                                                             |                  |                                                                        |              |                                                |                                                                                                                          |                 |                    |                                     |                 |                                                                        |  |
