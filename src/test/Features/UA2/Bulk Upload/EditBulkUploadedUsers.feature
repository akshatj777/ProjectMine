Feature: Edit bulk uploaded users
  ...
  Scenario Outline: Scenario to edit user by - <description>
    ...
    Examples: 
      ...
      | Change role to DP(only M3) and data permissions                | Super Admin | Remedy Other                    | Remedy Other                    | Downstream Provider           |     | ROFirstName                                        | ROLastName                                         | 767-687-8998 | Episode Connect, Episode Connect Classic, Episode Connect for Post-acute Care, Care Innovation Institute                                                                        |                                                 | Healthsystem - Downstream Provider             | Healthsystem - Downstream Provider--Downstream Organization                                                                  | Healthsystem - Downstream Provider--DOWN-ORG--Coosa Valley Health Care                                                                                                                                                                                                                                          | Episodes, Episode Connect for Post-acute Care, Care Innovation Institute                             | Administration, Remedy University, Reports          | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] |      | Coosa valley health care                                                                                                               |                                                                                                                                                                                                                                                          |  |
      | Changing role and data permissions                             | Super Admin | Partner Technical Administrator | Partner Technical Administrator | Downstream Provider           |     | PTAFirstName                                       | PTALastName                                        |              | Episode Connect, Episode Connect Classic, Episode Connect for Post-acute Care, Care Innovation Institute                                                                        |                                                 | Healthsystem - Downstream Provider, Altercare  | Healthsystem - Downstream Provider--Downstream Organization, Altercare--BPCI Model 3                                         | Healthsystem - Downstream Provider--DOWN-ORG--Stamford Memorial Hospital, Altercare--3056-m03--Altercare - Alliance                                                                                                                                                                                             | Episodes, Episode Connect for Post-acute Care, Care Innovation Institute                             | Administration, Remedy University, Reports          | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] |      | Coosa valley health care                                                                                                               |                                                                                                                                                                                                                                                          |  |
      | Changing role, general details, applications, data permissions | Super Admin | Remedy Technical Administrator  | Remedy Technical Administrator  | Physicians                    | NPI | FirstnameeFirstnameeFirstnameeFirstnameeFirstnamee | LastnameeeLastnameeeLastnameeeLastnameeeLastnameee | 345-676-5432 | Episode Connect, Episode Connect Classic, Reporting Classic, Remedy University, Reporting, Care Innovation Institute                                                            |                                                 | Hospital For Special Surgery                   | Hospital For Special Surgery--BPCI Model 2                                                                                   | Hospital For Special Surgery--2070-046--Hss - Hospital For Special Surgery                                                                                                                                                                                                                                      |                                                                                                      |                                                     |          |                |                              |      | HSS - Hospital for Special Surgery                                                                                                     |                                                                                                                                                                                                                                                          |  |
      ...
      | Edit Data permissions                                          | Super Admin | Remedy Field RN                 | Remedy Field RN                 | Remedy Field RN               |     | RFRNFirstName                                      | RFRNLastName                                       |              | Episode Connect, Episode Connect Classic, Episode Connect for Post-acute Care, Reporting Classic, Care Innovation Institute, Remedy University                                  |                                                 | Stamford Hospital, TeamHealth                  | Stamford Hospital--BPCI Model 2, TeamHealth--BPCI Model 3                                                                    | Stamford Hospital--2070-015--Stamford Hospital, TeamHealth--3056-q91--The Medical Center At Franklin                                                                                                                                                                                                            | Episodes, Episode Connect for Post-acute Care, Reports, Care Innovation Institute, Remedy University | Administration                                      | ROLE_FRN | Patient ID     | Episode DRG Issues [Model 3] |      | Stamford Hospital, The Medical Center At Franklin                                                                                      | i am learning path, Learning Pathway 2, max-test-052417, New learning Path, Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2                    |  |
      | Edit Data permissions                                          | Super Admin | Partner Program Administrator   | Partner Program Administrator   | Partner Program Administrator |     | PPAFirstName                                       | PPALastName                                        |              | Episode Connect, Episode Connect Classic, Reporting Classic, Remedy University, Episode Connect for Post-acute Care, Care Innovation Institute                                  |                                                 | United Health Services of New York, TeamHealth | TeamHealth--BPCI Model 3, United Health Services of New York--BPCI Model 3, United Health Services of New York--BPCI Model 2 | United Health Services of New York--3090-209--Uhs Twin Tier Home Health Inc, United Health Services of New York--6005-197--Binghamton General-sandiford Rehabilitation Center, TeamHealth--3056-q91--Rhea Medical Center, TeamHealth--3056-q91--The Medical Center At Franklin, TeamHealth--3056-q99--204595837 | Episodes, Reports, Care Innovation Institute, Remedy University                                      | Administration                                      | ROLE_PRM | Patient ID     | Episode DRG Issues [Model 3] |      | Rhea Medical Center, The Medical Center At Franklin, Uhs Twin Tier Home Health Inc, Binghamton General-sandiford Rehabilitation Center | i am learning path, Learning Pathway 2, max-test-052417, Physician Acute Care Hospital Model 2, Remedy University                                                                                                                                        |  |
