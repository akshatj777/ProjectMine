Feature: Edit bulk uploaded users
  ...
  Scenario Outline: Scenario to edit user by - <description>
    ...
    Examples: 
      ...
      | Changing role and data permissions                             | Super Admin | Partner Technical Administrator | Partner Technical Administrator | Downstream Provider           |     | PTAFirstName                                       | PTALastName                                        |              | Episode Connect, Episode Connect Classic, Episode Connect for Post-acute Care, Care Innovation Institute                                                                        |                                                 | Healthsystem - Downstream Provider             | Healthsystem - Downstream Provider--Downstream Organization                                                                  | Healthsystem - Downstream Provider--DOWN-ORG--Stamford Memorial Hospital                                                                                                                                                                                                                         | Episodes, Episode Connect for Post-acute Care, Care Innovation Institute                             | Administration, Remedy University, Reports          | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] |      | Coosa valley health care                                                                                                                                      |                                                                                                                                                                                                                                                          |  |
