...
| Verify validation message for NPI as .    | Partner Technical Administrator | First Name | Last Name  | qaautomation@remedypartners.com | 9874563210 | Physicians | .........1 | Please enter a valid NPI          |  |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                       | User                            | Role    | Email             | Applications               | ApplicationsNotVisible                          | RemoveApplications | RemovePrograms | AddPrograms | RemoveLocations | AddLocations  | Facilities                                                                                        | LearningPathway                                                                                                                                  | FirstName | LastName                                 | Roletext | ReportCategory | ReportName                   | HealthSystemValidation | ProgramsValidation             |RemoveProgramsValidation| LocationsValidation                                                                                                                                                                   |
      | Edit multiple to single program                                                   | Partner Technical Administrator | Manager | qaautomation@remedypartners.com | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect | Episodes,Episodes  | BPCI-Model3    |             |                 |               | Adventist Health Bakersfield                                                                      | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues           | Sound Physicians       | Sound Physicians--BPCI Model 2 |Sound Physicians--BPCI Model 3| Sound Physicians--6005-059--Adventist Health Bakersfield                                                                                                                              |
