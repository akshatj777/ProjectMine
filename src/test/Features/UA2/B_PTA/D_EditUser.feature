Feature: Edit user page for PTA
  ...
  Scenario Outline: Change General information and edit apps
    ...
    Examples: 
      ...
      | Partner Technical Administrator | FirstName'Edited | LastName'Edited | qaautomation@remedypartners.com@remedypartners.com | 996-385-2451 | NPI | Physicians | Reports            | Episodes, Lessons | Reports, Episodes 2.0, Administration | p11D0Vl2FSg1      | Executive Acute Care Hospital Model 2 | ROLE_CLINICIAN | Patient ID     | Episode DRG Issues [Model 3] |      | Pacific Coast Manor, Sunrise Skilled Nursing & Rehabilitation Center, Pyramid Point Post-Acute Rehabilitation Center, Hilltop Skilled Nursing, McCormick's Creek | Clinical Operations Acute Care Hospital Model 2 |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Verify validation message for blank First name        | Partner Technical Administrator |            | Last Name  | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians |            | First Name is required            |  |
      | Verify validation message for blank Last name         | Partner Technical Administrator | First Name |            | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians |            | Last Name is required             |  |
      | Verify validation message for blank NPI               | Partner Technical Administrator | First Name | Last Name  | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians |            | NPI is required                   |  |
      | Verify validation message for invalid Phone           | Partner Technical Administrator | First Name | Last Name  | qaautomation@remedypartners.com@remedypartners.com |     123564 | Physicians | NPI        | Please enter a valid phone number |  |
      | Verify validation message for NPI less than 10 digits | Partner Technical Administrator | First Name | Last Name  | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians |     123564 | Please enter a valid NPI          |  |
      | Verify validation message for NPI as alphabets        | Partner Technical Administrator | First Name | Last Name  | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians | abcdefgihj | Please enter a valid NPI          |  |
      | Verify validation message for NPI as alphanumeric     | Partner Technical Administrator | First Name | Last Name  | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians | abcde12345 | Please enter a valid NPI          |  |
      | Verify validation message for invalid First Name      | Partner Technical Administrator | 8473827919 | Last Name  | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians | NPI        | Please enter a valid name         |  |
      | Verify validation message for invalid Last name       | Partner Technical Administrator | First Name | 8473827919 | qaautomation@remedypartners.com@remedypartners.com | 9874563210 | Physicians | NPI        | Please enter a valid name         |  |
  ...
  Scenario Outline: Changing role from physician to Manager then back to Physicians
    ...
    Examples: 
      ...
      | Partner Technical Administrator | qaautomation@remedypartners.com@remedypartners.com |      | NPI  | Physicians   | Manager |                    | Episodes, Reports, Physician Connect, Lessons, Physician Connect | Administration, Episodes 2.0 |                                | ROLE_PRM | Patient ID     | Episode DRG Issues [Model 3] |      | i am learning path, Learning Pathway 2, max-test-052417, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2 | FirstName | LastName | Apple - Watertown |

  Scenario Outline: <Description>
    #Given I am on mail login page
    #Then I enter username "qaautomation@remedypartners.com@remedypartners.com" to login mail account
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Partner Technical Administrator User and create user with Manager role | Partner Technical Administrator | FirstName | LastNameLastNameLastNameLastNameLastName | qaautomation@remedypartners.com@remedypartners.com |       | Manager | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect, TCI |     | p11D0Vl2FSg1, qfy2xp8zSFc1, 18h7phZr1h81, n9yn5n0Qa581 | Sound Physicians | BPCI-Model2 | 6005-059--Adventist Health Bakersfield |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: Edit locations -<Description>
    ...
    Examples: 
      ...
      | Single locations to multi locations | Partner Technical Administrator | FirstName | LastNameLastNameLastNameLastNameLastName | qaautomation@remedypartners.com@remedypartners.com |       |     | Manager | Episodes, Episodes | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician connect | Sound Physicians | BPCI-Model2 |                                          | 6005-059--Adventist Bolingbrook Hospital | ROLE_PRM | Patient ID     | Episode DRG Issues |      | Adventist Bolingbrook Hospital, Adventist Health Bakersfield | Sound Physicians       | Sound Physicians--BPCI Model 2 | Sound Physicians--6005-059--Adventist Health Bakersfield, Sound Physicians--6005-059--Adventist Bolingbrook Hospital | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University |
      | Edit to All locations               | Partner Technical Administrator | FirstName | LastNameLastNameLastNameLastNameLastName | qaautomation@remedypartners.com@remedypartners.com |       |     | Manager | Episodes, Episodes | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician connect | Sound Physicians | BPCI-Model2 |                                          | All Locations                            | ROLE_PRM | Patient ID     | Episode DRG Issues |      | Adventist Bolingbrook Hospital, Adventist Health Bakersfield | Sound Physicians       | Sound Physicians--BPCI Model 2 | Sound Physicians--6005-059--Adventist Health Bakersfield, Sound Physicians--6005-059--Adventist Bolingbrook Hospital | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University |
      | All locations to Single locations   | Partner Technical Administrator | FirstName | LastNameLastNameLastNameLastNameLastName | qaautomation@remedypartners.com@remedypartners.com |       |     | Manager | Episodes, Episodes | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician connect | Sound Physicians | BPCI-Model2 | 6005-059--Adventist Bolingbrook Hospital |                                          | ROLE_PRM | Patient ID     | Episode DRG Issues |      | Adventist Health Bakersfield                                 | Sound Physicians       | Sound Physicians--BPCI Model 2 | Sound Physicians--6005-059--Adventist Health Bakersfield                                                             | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                       | User                            | FirstName | LastName                                 | Email                                              | Phone | Role    | Applications               | ApplicationsNotVisible                          | NPI | LearningPathwaySearchParameter                         | Health System1           | Programs1             | Locations1                                                          | HasHealthSystem2 | Health System2 | Programs2 | Locations2 | HasHealthSystem3 | Health System3 | Programs3 | Locations3 |
      | Login with Partner Technical Administrator User and create user with Manager role | Partner Technical Administrator | FirstName | LastNameLastNameLastNameLastNameLastName | qaautomation@remedypartners.com@remedypartners.com |       | Manager | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect |     | p11D0Vl2FSg1, qfy2xp8zSFc1, 18h7phZr1h81, n9yn5n0Qa581 | Butler Memorial Hospital | BPCI-Model2, BPCI-CJR | 2070-a55--Butler Memorial Hospital, CJR-1--Butler Memorial Hospital |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                     | User                            | Role    | Email                                              | Applications               | ApplicationsNotVisible                          | RemoveApplications | RemovePrograms | AddPrograms | RemoveLocations | AddLocations  | Facilities               | LearningPathway                                                                                                                                  | FirstName | LastName                                 | Roletext | ReportCategory | ReportName         | HealthSystemValidation   | ProgramsValidation                                                         | LocationsValidation                                                                                                     |
      | Edit single to multiple program | Partner Technical Administrator | Manager | qaautomation@remedypartners.com@remedypartners.com | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect | Episodes,Episodes  |                |             |                 | All Locations | Butler Memorial Hospital | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues | Butler Memorial Hospital | Butler Memorial Hospital--BPCI Model 2, Butler Memorial Hospital--BPCI-CJR | Butler Memorial Hospital--2070-a55--Butler Memorial Hospital, Butler Memorial Hospital--CJR-1--Butler Memorial Hospital |
      | Edit multiple to single program | Partner Technical Administrator | Manager | qaautomation@remedypartners.com@remedypartners.com | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect | Episodes,Episodes  | BPCI-Model2    |             |                 |               | Butler Memorial Hospital | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues | Butler Memorial Hospital | Butler Memorial Hospital--BPCI-CJR                                         | Butler Memorial Hospital--CJR-1--Butler Memorial Hospital                                                               |
