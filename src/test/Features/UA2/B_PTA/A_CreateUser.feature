Feature: Create User - PTA User
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Partner Technical Administrator User and create user with Executive role    | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName | LastNameLastNameLastNameLastNameLastName | qaautomation | 9988776655 | Executive    | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect, TCI |     | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2 | RWJ Barnabas Health, INC | BPCI-CJR  | CJR-10-6--Monmouth Medical Center - Southern Campus, CJR-10-1--Rwj University Hospital At New Brunswick |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Manager role      | Partner Technical Administrator | FirstName                            | LastNameLastNameLastNameLastNameLastName | qaautomation |            | Manager      | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect, TCI |     | p11D0Vl2FSg1, qfy2xp8zSFc1, 18h7phZr1h81, n9yn5n0Qa581                                                             | RWJ Barnabas Health, INC | BPCI-CJR  | CJR-10-6--Monmouth Medical Center - Southern Campus, CJR-10-1--Rwj University Hospital At New Brunswick |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Case Manager role | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName | LastName                                 | qaautomation |            | Case Manager | Episodes, Reports, Lessons | Episodes 2.0, Administration, Physician Connect, TCI |     | Care Coordination External                                                                                         | RWJ Barnabas Health, INC | BPCI-CJR  | All Locations                                                                                           |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                         | User                            | FirstName                                 | LastName                                 | Email             | Phone      | Role                      | Applications                         | ApplicationsNotVisible                               | NPI | LearningPathwaySearchParameter                                                                                     | Health System1 | Programs1                | Locations1                                                                                                | HasHealthSystem2 | Health System2 | Programs2 | Locations2 | HasHealthSystem3 | Health System3 | Programs3 | Locations3 |
      | Login with Partner Technical Administrator User and create user with Executive role                 | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | qaautomation | 9988776655 | Executive                 | Episodes                             | Episodes 2.0, Administration, Physician Connect, TCI |     | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2 | TeamHealth     | BPCI-Model2              | 2070-g14--North Shore Med Center                                                                          |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Manager role                   | Partner Technical Administrator | FirstName                                 | LastNameLastNameLastNameLastNameLastName | qaautomation |            | Manager                   | Episodes, Reports                    | Episodes 2.0, Administration, Physician Connect, TCI |     | p11D0Vl2FSg1, qfy2xp8zSFc1, 18h7phZr1h81, n9yn5n0Qa581                                                             | TeamHealth     | BPCI-Model2              | All Locations                                                                                             |                  |                |           |            |                  |                |           |            |
      ...
      | Login with Partner Technical Administrator User and create user with Physicians role                | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | qaautomation | 9988776655 | Physicians                | Episodes, Reports, Physician Connect | Episodes 2.0, Administration, TCI                    | NPI | p11D0Vl2FSg1, Executive Acute Care Hospital Model 2                                                                | TeamHealth     | BPCI-Model2, BPCI-Model3 | 2070-g14--North Shore Med Center, 3056-q91--Rhea Medical Center, 3056-q91--The Medical Center At Franklin |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Transitional Case Manager role | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstNameFirst | LastName                                 | qaautomation | 9988776655 | Transitional Case Manager | Reports                              | Episodes 2.0,Administration, Physician Connect, TCI  |     | 5HDc3E6aK_E1, p11D0Vl2FSg1, qfy2xp8zSFc1, 18h7phZr1h81                                                             | TeamHealth     | BPCI-Model2, BPCI-Model3 | 2070-g14--Baptist Medical Center  Beaches, 2070-g14--Mercy Hospital, 2070-g14--North Shore Med Center     |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      | Description                                                                                         | User                            | FirstName                                 | LastName                                 | Email             | Phone      | Role                      | Applications                                  | ApplicationsNotVisible                               | NPI | LearningPathwaySearchParameter                                                                                     | Health System1 | Programs1   | Locations1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | HasHealthSystem2 | Health System2 | Programs2 | Locations2 | HasHealthSystem3 | Health System3 | Programs3 | Locations3 |
      | Login with Partner Technical Administrator User and create user with Executive role                 | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | qaautomation | 9988776655 | Executive                 | Episodes, Reports, Lessons                    | Episodes 2.0, Administration, Physician Connect, TCI |     | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2 | Covenant       | BPCI-Model3 | 3056-804--Catered Manor Nursing Center, 3056-805--Downey Care Center, 3056-806--Encinitas Nursing And Rehabilitation Center                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                  |                |           |            |                  |                |           |            |
      | Login with Partner Technical Administrator User and create user with Manager role                   | Partner Technical Administrator | FirstName                                 | LastNameLastNameLastNameLastNameLastName | qaautomation |            | Manager                   | Episodes, Reports, Lessons                    | Episodes 2.0, Administration, Physician Connect, TCI |     | p11D0Vl2FSg1, qfy2xp8zSFc1, 18h7phZr1h81, n9yn5n0Qa581                                                             | Covenant       | BPCI-Model3 | 3056-808--Arbor Nursing Center                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |                  |                |           |            |                  |                |           |            |
      ...
      | Login with Partner Technical Administrator User and create user with Physicians role                | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastNameLastNameLastNameLastNameLastName | qaautomation | 9988776655 | Physicians                | Episodes, Reports, Physician Connect, Lessons | Episodes 2.0, Administration, TCI                    | NPI | p11D0Vl2FSg1, Executive Acute Care Hospital Model 2                                                                | Covenant       | BPCI-Model3 | 3056-i37--Pacific Coast Manor, 3056-i38--Sunrise Skilled Nursing & Rehabilitation Center, 3056-i39--Pyramid Point Post, 3056-i40--Hilltop Skilled Nursing, 3056-i41--Mccormick                                                                                                                                                                                                                                                                                                                                                                                                                                               |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Verify validation message for blank First name        |            | Last Name  | qaautomation | 9874563210 | Executive  |            | First Name is required            |
      | Verify validation message for blank Last name         | First Name |            | qaautomation | 9874563210 | Executive  |            | Last Name is required             |
      | Verify validation message for blank Email             | First Name | Last Name  |                   | 9874563210 | Executive  |            | Email is required                 |
      | Verify validation message for blank NPI               | First Name | Last Name  | qaautomation | 9874563210 | Physicians |            | NPI is required                   |
      ...
      | Verify validation message for invalid Phone           | First Name | Last Name  | qaautomation |     123564 | Physicians | NPI        | Please enter a valid phone number |
      | Verify validation message for NPI less than 10 digits | First Name | Last Name  | qaautomation | 9874563210 | Physicians |     123564 | Please enter a valid NPI          |
      | Verify validation message for NPI as alphabets        | First Name | Last Name  | qaautomation | 9874563210 | Physicians | abcdefgihj | Please enter a valid NPI          |
      | Verify validation message for NPI as alphanumeric     | First Name | Last Name  | qaautomation | 9874563210 | Physicians | abcde12345 | Please enter a valid NPI          |
      | Verify validation message for invalid First Name      | 8473827919 | Last Name  | qaautomation | 9874563210 | Physicians | NPI        | Please enter a valid name         |
      | Verify validation message for invalid Last name       | First Name | 8473827919 | qaautomation | 9874563210 | Physicians | NPI        | Please enter a valid name         |
  ...
  Scenario Outline: Verify validation message for invalid lesson name in search box
    ...
    And I enter Email "qaautomation" to Create user
    When I click the Organizational Role Field
    Then I pick a Organizational <Role>
    Then I click on Next button
    Then I verify the header "Applications"
  ...
  Scenario Outline: Verify that Next button and left side menu is enabled only when mandatory fields are selected
    ...
    Examples: 
      ...
      | First'Name | Last'Name | qaautomation | Physicians | NPI | Reports      | 3056-804--Catered Manor Nursing Center |
  ...
  Scenario Outline: Enter invalid location and verify error message
    ...
    Examples: 
      ...
      | FirstName | LastName | qaautomation | 9988776655 | Case Manager | Reports      |     | hkfj             |
  ...
  Scenario Outline: Creating user with existing NPI and validating error message
    ...
    Examples: 
      ...
      | Partner Technical Administrator | FirstName | LastName | qaautomation | Physicians | Reports      |     | BPCI-Model3 | Covenant      | 3056-808--Arbor Nursing Center |
  ...
  Scenario Outline: Creating user with existing Email and validating error message
    ...
    Examples: 
      ...
      | Partner Technical Administrator | FirstName | LastName | qaautomation | Physicians | Reports      | NPI | BPCI-Model3 | 3056-808--Arbor Nursing Center |
