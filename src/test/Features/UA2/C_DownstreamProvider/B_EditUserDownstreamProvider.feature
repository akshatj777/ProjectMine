Feature: Edit page for Downstream provider
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Super Admin User and create user with Remedy TCS role | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstName | LastName | test.automatemail2 |       | Remedy TCS | Episodes, Episodes 2.0, Reports, TCI, Lessons | Administration, Physician Connect |     | Learning Pathway 2, jusUV22erpk1, Clinical Operations Acute Care Hospital Model 2, n9yn5n0Qa581, 18h7phZr1h81 | Stamford Hospital | BPCI-Model2 | 2070-015--Stamford Hospital | Yes              | Altercare      | BPCI-Model3 | 3056-m03--Altercare - Alliance | No               |                |           |            |
  ...
  Scenario Outline: Remove exiting health System and new org
    ...
    Examples: 
      ...
      | Super Admin | test.automatemail2 | Downstream Provider | FirstNameEdited | LastNameEdited | 996-385-2451 | Episodes          | Episodes, Episodes 2.0 | Administration, Physician Connect, Reports, Lessons | Covenant            | Yes              | Apple Rehab    | 3056-i11--Apple - Watertown | Healthsystem - Downstream Provider, Apple Rehab | Apple Rehab--BPCI Model 3, Healthsystem - Downstream Provider--Downstream Organization | Apple Rehab--3056-i11--Apple - Watertown, Healthsystem - Downstream Provider--DOWN-ORG--Coosa Valley Health Care, Healthsystem - Downstream Provider--DOWN-ORG--020653 | ROLE_SNF | Patient ID     | Episode DRG Issues [Model 3] | i am learning path, Learning Pathway 2, Remedy University |      | Apple - Watertown, Coosa valley health care, Alaris Health at Jersey City |
