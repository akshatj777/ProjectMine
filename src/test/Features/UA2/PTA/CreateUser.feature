Feature: Create User - PTA User
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Partner Technical Administrator User and create user with Advanced Operator role | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastName                                 | qaautomation@remedypartners.com |            | Advanced Operator | Episode Connect Classic, Remedy University | Administration, Care Innovation Institute |     | Remedy University, Care Coordination External, Physician Acute Care Hospital Model 2 | Sound Physicians | BPCI Model 2, BPCI Model 3 | All Locations                                  |                  |                |           |            |                  |                |           |            |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Advanced Operator and verify Product Tiles and their redirections | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName      | LastName                                 | Advanced Operator | Episodes Classic, Remedy University, Care Innovation Institute | Administration, Reporting Classic, Reporting                   | ROLE_TCS | Patient ID     | Episode DRG Issues           |      | Remedy University, Care Coordination External, Physician Acute Care Hospital Model 2 | Presence Saint Joseph Medical Center, Mountainview Hospital, Vaughan Regional Medical Center Parkway Campus, San Mateo Medical Center, Aroostook Medical Center, Mayo Clinic Health System - Mankato, St Vincent Healthcare, St Rose Dominican Hospitals - Rose De Lima Campus, Desert Springs Hosp MC, Summerlin Hospital Medical Center, St Rose Dominican Hospitals - Siena Campus |
