Feature: Edit user scenarios from PTA
  ...
  Scenario Outline: <Description>
   ...
   #When I click on field-panel-icon button for "<User>-<Role>" user
    ...
    Examples: 
      ...
      | Edit multiple to single program                                                   | Partner Technical Administrator | qaautomation@remedypartners.com |     |            |              | Manager    |                       |                                                     | Episode Connect Classic, Reporting Classic, Lessons                    |                     | Episode Connect Classic, Reporting Classic, Lessons | Episode Connect for Post-acute Care, Administration, Physician Connect                    |                                                                                                                               |                   |                                                                                        |                                | ROLE_PRM       | Patient ID     | Episode DRG Issues           |      | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | Adventist Health Bakersfield                                                                      |                                          | BPCI-Model3    |             |                                                                                 | Sound Physicians        | Sound Physicians--BPCI Model 2                                 | Sound Physicians--6005-059--Adventist Health Bakersfield                                                                                                                              | Sound Physicians--3090-069--Penobscot Bay Medical Center, Sound Physicians--3090-079--Aiken Regional Medical Center                                                                   | Sound Physicians--BPCI Model 3 |
      ...
      | Remove existing Program(Mod-3) and select another Program and check all locations | Partner Technical Administrator | qaautomation@remedypartners.com |     |            |              | Manager    |                       |                                                     | Episode Connect Classic, Reporting Classic, Lessons                    |                     | Episode Connect Classic, Reporting Classic, Lessons | Episode Connect for Post-acute Care, Administration, Physician Connect                    |                                                                                                                               |                   |                                                                                        |                                | ROLE_PRM       | Patient ID     | Episode DRG Issues           |      | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | Adventist Health Bakersfield, Adventist Bolingbrook Hospital                                      |                                          | BPCI-Model3    | BPCI-Model2 | All Locations                                                                   | Sound Physicians        | Sound Physicians--BPCI Model 2                                 | Sound Physicians--6005-059--Adventist Health Bakersfield, Sound Physicians--6005-059--Adventist Bolingbrook Hospital                                                                  | Sound Physicians--3090-066--Presence Saint Joseph Medical Center, Sound Physicians--3090-069--Penobscot Bay Medical Center, Sound Physicians--3090-079--Aiken Regional Medical Center | Sound Physicians--BPCI Model 3 |
  ...
  Scenario Outline: Selected locations for Model-2 are not getting displayed as selected after unchecking Model-2 from program drop down while editing the user
    ...
    Examples: 
      ...
      | Partner Technical Administrator | qaautomation@remedypartners.com | Physicians | Sound Physicians | BPCI-Model2    | 6005-059--Adventist Health Bakersfield |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Edit single to multiple program | Partner Technical Administrator | Manager | qaautomation@remedypartners.com | Episode Connect Classic, Reporting Classic, Lessons | Episode Connect for Post-acute Care, Administration, Physician Connect | Episode Connect Classic,Episode Connect Classic |                |             |                 | All Locations | Butler Memorial Hospital | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues | Butler Memorial Hospital | Butler Memorial Hospital--BPCI Model 2, Butler Memorial Hospital--BPCI-CJR | Butler Memorial Hospital--2070-a55--Butler Memorial Hospital, Butler Memorial Hospital--CJR-1--Butler Memorial Hospital |
      | Edit multiple to single program | Partner Technical Administrator | Manager | qaautomation@remedypartners.com | Episode Connect Classic, Reporting Classic, Lessons | Episode Connect for Post-acute Care, Administration, Physician Connect | Episode Connect Classic,Episode Connect Classic | BPCI-Model2    |             |                 |               | Butler Memorial Hospital | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | FirstName | LastNameLastNameLastNameLastNameLastName | ROLE_PRM | Patient ID     | Episode DRG Issues | Butler Memorial Hospital | Butler Memorial Hospital--BPCI-CJR                                         | Butler Memorial Hospital--CJR-1--Butler Memorial Hospital                                                               |
