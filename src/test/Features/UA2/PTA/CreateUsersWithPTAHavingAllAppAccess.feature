Feature: Create User - PTA User
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Login with Partner Technical Administrator User and create user with Operator role          | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstNameFirst | LastName                                 | qaautomation@remedysystems.com | 9988776655 | Operator          | Workflow Reporting Only                               | Episode Connect Classic, Reporting Classic, Reporting, Remedy University | Episode Connect, Reporting Classic, Care Innovation Institute                          | Episode Connect for Post-acute Care, Community Connect, Care Connect, Administration, Program Management |     |                                                                                      | Sound Physicians | BPCI Model 3               | All Locations                                  |                  |                |           |            |                  |                |           |            |
