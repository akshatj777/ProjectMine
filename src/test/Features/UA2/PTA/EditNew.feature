Feature: fhdks
  ...
  Scenario Outline: Change General information and edit apps
    ...
    Examples: 
      ...
      | Multiple locations to single locations                           | Partner Technical Administrator | qaautomation@remedypartners.com |     |              |              | Transitional Case Manager |                       |                            | Episodes, Reports, Lessons                    |                     | Episodes, Reports, Lessons                    | Episodes 2.0, Administration, Physician connect |                                       |                   |                                   |                                | ROLE_TCS       | Patient ID     | Episode DRG Issues [Model 3] |      | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2 | FirstNameFirstNameFirstNameFirstNameFirst | LastName                                 | Highland Health                                                                                                                                                  | 3056-i42--Palo Alto Sub, 3056-i43--Meadow Manor, 3056-i44--Villa Georgetown                                                 |                |             |                                                                                  | Covenant                | Covenant--BPCI Model 3 | Covenant--3056-i45--Highland Health                                                                                                            |  |
      | Single locations to multi locations                              | Partner Technical Administrator | qaautomation@remedypartners.com |     |              |              | Manager                   |                       |                            | Episodes, Reports, Lessons                    |                     | Episodes, Reports, Lessons                    | Episodes 2.0, Administration, Physician connect |                                       |                   |                                   |                                | ROLE_PRM       | Patient ID     | Episode DRG Issues [Model 3] |      | Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University          | FirstName                                 | LastNameLastNameLastNameLastNameLastName | Arbor Nursing Center, Courtyard Health Care Center, Emerald Gardens Nursing Center                                                                               |                                                                                                                             |                |             | 3056-809--Courtyard Health Care Center, 3056-810--Emerald Gardens Nursing Center | Covenant                | Covenant--BPCI Model 3 | Covenant--3056-809--Courtyard Health Care Center, Covenant--3056-810--Emerald Gardens Nursing Center, Covenant--3056-808--Arbor Nursing Center |  |
      | Changing General information, Role and Edit apps and permissions | Partner Technical Administrator | qaautomation@remedypartners.com | NPI |              | Executive    | Physicians                | Physician Connect     | Episodes, Reports, Lessons | Episodes, Reports, Lessons, Physician Connect |                     | Episodes, Reports, Lessons, Physician Connect | Episodes 2.0, Administration                    |                                       |                   |                                   |                                | ROLE_CLINICIAN | Patient ID     | Episode DRG Issues [Model 3] |      | Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2                                        | FirstNameEdited                           | LastNameEdited                           | Arbor Nursing Center                                                                                                                                             | 3056-804--Catered Manor Nursing Center, 3056-805--Downey Care Center, 3056-806--Encinitas Nursing And Rehabilitation Center |                |             | 3056-808--Arbor Nursing Center                                                   | Covenant                | Covenant--BPCI Model 3 | Covenant--3056-808--Arbor Nursing Center                                                                                                       |  |
