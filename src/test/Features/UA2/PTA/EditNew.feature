Feature: Merged Edit user scenarios from PTA
  ...
  Scenario Outline: Create User through UA API call
    ...
    Examples: 
      ...
      | Partner Technical Administrator | FirstNameFirstNameFirstNameFirstName | LastNameLastNameLastNameLastNameLastName | qaautomation@remedypartners.com | 9988776655 | NPI | Physicians                      | 4-Physicians                       | episode_connect-Episodes,reports-Reports,lessons-Lessons,physician_portal-Physician Connect                      | p11D0Vl2FSg1,qfy2xp8zSFc1                              | 441324--3090-066--140007, 441324--3090-069--200063, 441324--3090-079--420082, 441324--6005-059--050455, 441324--6005-059--140304 |           200 |
  ...
  Scenario Outline: Editing any role to Physicians (without saving) and back to same role/other role
    ...
    Examples: 
      ...
      | Partner Technical Administrator | lbarinstein+qaadmin@remedypartners.com | Testing1 | qaautomation@remedypartners.com | NPI | Manager      | Physicians | Case Manager |
