Feature: Verification of Landing Page for PTA User
  ...
  Scenario Outline: Create User through UA API call
    ...
    Examples: 
      ...
      | Super Admin | FirstName | LastNameLastNameLastNameLastNameLastName | qaautomation@remedysystems.com |       |     | Partner Technical Administrator2 | 20-Partner Technical Administrator2 | episode_connect-Episode Connect Classic, reports-Reporting Classic                                                                       | NFdw0Kts2C01,HZhmTBQzHtU1,n9yn5n0Qa581 | 441324--6005-059--140007, 441324--3090-070--010085                                                                                                                                                                                                                                                                                                                         |           200 |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | View PTA2 from PTA1 having same data permissions | Super Admin | Partner Technical Administrator1 | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstName | LastNameLastNameLastNameLastNameLastName |       | Partner Technical Administrator2 | Episode Connect, Episode Connect Classic, Reporting Classic, Care Innovation Institute | Reporting, Remedy University | Episode Connect for Post-acute Care, Community Connect, Care Connect, Administration, Program Management                               |     |                 | Sound Physicians | Sound Physicians--BPCI Model 2 | Sound Physicians--6005-059--Presence Saint Joseph Medical Center |
      | View PTA1 from PTA2 having same data permissions | Super Admin | Partner Technical Administrator2 | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstName | LastNameLastNameLastNameLastNameLastName |       | Partner Technical Administrator1 | Episode Connect, Episode Connect Classic, Reporting Classic, Care Innovation Institute |                              | Episode Connect for Post-acute Care, Community Connect, Care Connect, Administration, Program Management, Remedy University, Reporting |     |                 | Sound Physicians | Sound Physicians--BPCI Model 2 | Sound Physicians--6005-059--Presence Saint Joseph Medical Center |
