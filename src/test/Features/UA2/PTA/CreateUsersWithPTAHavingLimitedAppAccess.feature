Feature: Create User - PTA User
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | View Operator user created from Super Admin user     | Partner Technical Administrator | lbarinstein+qaadmin@remedypartners.com | Testing1 | FirstNameFirstNameFirstNameFirstNameFirst | LastName                                 | 998-877-6655 | Operator          | Episode Connect, Care Innovation Institute                                     | Reporting Classic, Remedy University, Episode Connect Classic, Reporting | Episode Connect for Post-acute Care, Community Connect, Care Connect, Administration, Program Management |     |                 | RWJ Barnabas Health | RWJ Barnabas Health--bpci_a                           | RWJ Barnabas Health--5772-0002--Clara Maass Medical Center, RWJ Barnabas Health--5774-0002--Community Medical Center - Tom's River, RWJ Barnabas Health--5838-0002--Monmouth Medical Center, RWJ Barnabas Health--5805-0002--JERSEY CITY MEDICAL CENTER, RWJ Barnabas Health--5839-0002--Monmouth Medical Center - Southern Campus                                                                                                                                                                                                                                                                                                                                                                   |
