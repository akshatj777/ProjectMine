Feature: Edit user page for SA
  ...
  Scenario Outline: Verifying editable/non-editable fields of general information tab and editing them
    ...
    Examples: 
      ...
      | Super Admin | Physicians | FirstName'Edited | LastName'Edited | test.automatemail2 | 996-385-2451 | NPI | i am learning path, 18h7phZr1h81     | n9yn5n0Qa581      | Episodes, Episodes |
  ...
  Scenario Outline: Editing user role from <PreviousRole> to <Role>
    ...
    Examples: 
      ...
      | Super Admin | lbarinstein+qaadmin@remedypartners.com | Testing1 | test.automatemail2 |     | Manager      | Partner Program Administrator | Physician Connect  | Episodes, Reports, Physician Connect, Lessons, Physician Connect | Episodes, Reports, Lessons | Administration, Episodes 2.0 |                                | ROLE_PRM | Patient ID     | Episode DRG Issues [Model 3] |      | i am learning path, Learning Pathway 2, max-test-052417, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2 | FirstName | LastName | Apple - Watertown |
  ...
  Scenario Outline: Changing the products and general details for <Role> and verifying product tile
    ...
    Examples: 
      ...
      | Super Admin | Case Manager | test.automatemail2 | Reports             | Episodes, TCI, Lessons     | Episodes 2.0, Administration, Physician Connect, Reports | ROLE_TCS | Patient ID     | Episode DRG Issues           |      | i am learning path, Learning Pathway 2, max-test-052417, Care Coordination External                                                                                                                                                                      | Allentown, Bethlehem, Anderson                                                                                                                                      | FirstName | LastName |
      | Super Admin | Remedy RN    | test.automatemail2 | Reports, Episodes   | Episodes 2.0, TCI, Lessons | Reports, Episodes, Administration, Physician Connect     | ROLE_RN  | Patient ID     | Episode DRG Issues [Model 3] |      | i am learning path, Learning Pathway 2, max-test-052417, New learning Path, Care Coordination External, Clinical Operations Acute Care Hospital Model 2, Executive Acute Care Hospital Model 2, Physician Acute Care Hospital Model 2, Remedy University | North Shore Med Center, Rhea Medical Center, The Medical Center At Franklin, Evanston Hospital, Jackson North Med Center, Warren Memorial Hospital, Herrin Hospital | FirstName | LastName |
  ...
  Scenario Outline: <Description>
    ...
    Examples: 
      ...
      | Verify validation message for blank First name        | Super Admin |            | Last Name  | test.automatemail2 | 9874563210 | Executive  |            | First Name is required            |
      | Verify validation message for blank Last name         | Super Admin | First Name |            | test.automatemail2 | 9874563210 | Executive  |            | Last Name is required             |
      | Verify validation message for blank NPI               | Super Admin | First Name | Last Name  | test.automatemail2 | 9874563210 | Physicians |            | NPI is required                   |
      | Verify validation message for invalid Phone           | Super Admin | First Name | Last Name  | test.automatemail2 |     123564 | Physicians | NPI        | Please enter a valid phone number |
      | Verify validation message for NPI less than 10 digits | Super Admin | First Name | Last Name  | test.automatemail2 | 9874563210 | Physicians |     123564 | Please enter a valid NPI          |
      | Verify validation message for NPI as alphabets        | Super Admin | First Name | Last Name  | test.automatemail2 | 9874563210 | Physicians | abcdefgihj | Please enter a valid NPI          |
      | Verify validation message for NPI as alphanumeric     | Super Admin | First Name | Last Name  | test.automatemail2 | 9874563210 | Physicians | abcde12345 | Please enter a valid NPI          |
      | Verify validation message for invalid First Name      | Super Admin | 8473827919 | Last Name  | test.automatemail2 | 9874563210 | Physicians | NPI        | Please enter a valid name         |
      | Verify validation message for invalid Last name       | Super Admin | First Name | 8473827919 | test.automatemail2 | 9874563210 | Physicians | NPI        | Please enter a valid name         |
